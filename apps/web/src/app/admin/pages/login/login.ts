...
import { lucideEye, lucideEyeOff, lucideLoader2 } from '@ng-icons/lucide';
 ...
 * mesmo campo que ele vai ver do outro lado da porta.
 */
@Component({
  selector: 'app-operator-login',
  standalone: true,
  imports: [ReactiveFormsModule, NgIcon, HlmToaster],
  providers: [provideIcons({ lucideEye, lucideEyeOff, lucideLoader2 })],
