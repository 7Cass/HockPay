...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'payment-links',
                loadComponent: () => import('./features/dashboard/pages/payment-links/payment-links').then(m => m.PaymentLinks),
            },
            {
                path: 'payment-links/:id',
                loadComponent: () => import('./features/dashboard/pages/payment-link-detail/payment-link-detail').then(m => m.PaymentLinkDetail),
            },
            {
                path: 'payments/:id',
            ...
            {
                path: 'withdrawals',
                loadComponent: () => import('./features/dashboard/pages/withdrawals/withdrawals').then(m => m.Withdrawals),
            },
            {
                path: 'withdrawals/:id',
                loadComponent: () => import('./features/dashboard/pages/withdrawal-detail/withdrawal-detail').then(m => m.WithdrawalDetail),
            },
            {
                path: 'settings',
