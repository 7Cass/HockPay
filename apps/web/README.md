...
| `/dashboard/settings` | `features/dashboard/pages/settings` | Perfil (`name`, `city`); fee/settlement read-only |
...
- Settings edita nome publico e cidade do EMV; nao e painel de taxa, liquidacao ou aprovacao.
