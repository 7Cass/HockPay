...
@Module({
    ...
    providers: [
        ...
        },
        {
            ...
            ) => new CreateBankAccountUseCase(bankAccountRepo, unitOfWork),
            inject: ['IBankAccountRepository', 'IUnitOfWork'],
        },
        {
            provide: ListBankAccountsUseCase,
            useFactory: (bankAccountRepo: IBankAccountRepository) => new ListBankAccountsUseCase(bankAccountRepo),
            inject: ['IBankAccountRepository'],
        },
        {
            provide: DeleteBankAccountUseCase,
            useFactory: (bankAccountRepo: IBankAccountRepository) => new DeleteBankAccountUseCase(bankAccountRepo),
            inject: ['IBankAccountRepository'],
        },
        {
            provide: GetMerchantUseCase,
            useFactory: (merchantRepo: IMerchantRepository) => new GetMerchantUseCase(merchantRepo),
