...
export const ERROR_CODE_MAP: Record<string, number> = {
  ...
  PAYMENT_LINK_CANNOT_BE_CANCELLED: 409,
  ...
  WEBHOOK_LOG_NOT_FOUND: 404,

  // Business rule errors (422 Unprocessable Entity)
  BANK_ACCOUNT_NOT_VERIFIED: 422,
  INSUFFICIENT_WITHDRAWAL_BALANCE: 422,
  STORE_INACTIVE: 422,
  STORE_LIVE_NOT_ENABLED: 422,
  INVALID_STORE_LIVE_STATUS_TRANSITION: 422,
  OPERATOR_DECISION_REASON_REQUIRED: 422,
  INVALID_COMMERCIAL_TERMS: 422,
